...
$ruta=$_REQUEST['path'];
?>
<h3>Rutas Distribucion</h3>
<div id="menu" align="left">
  <a class="btn btn-primary" onclick="editar('rutas_distribucion',0)" href="#modal-container-abm" data-toggle="modal"><span class="glyphicon glyphicon-plus-sign"></span> Nuevo</a>&emsp;
  <br />
  <hr>
</div>
